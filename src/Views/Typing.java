...
public class Typing extends javax.swing.JFrame {
         ...
         */
        private TypingController typeController;

        public Typing() {
                initComponents();
                this.typeController = new TypingController(this);
                this.typeController.getWord();
        }

        public void setTypeController(TypingController typeController) {
